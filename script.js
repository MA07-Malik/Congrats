...
function finalMessage(){
    ...
    setTimeout(()=>{
        ...
        end.style.background="rgba(0,0,0,.75)";
        ...
        animation:popupUp .7s;

        ">

        <h1 style="font-family:Playfair Display;color:#203A63">
        ...
        Congratulations on your 3.8 GPA.

        <br><br>

        May this be only the beginning of something beautiful.
